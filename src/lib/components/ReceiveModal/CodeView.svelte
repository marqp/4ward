...
<div class="p-6 md:p-8 flex-grow overflow-y-auto custom-scrollbar flex flex-col relative">
  ...
  {/if}
  <CodeInput onComplete={onData} />
  <button class="w-full py-4 mt-6 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-2xl transition-colors flex items-center justify-center gap-2 font-medium shadow-lg backdrop-blur-md" onclick={onBack}>
